...
use fil_actor_miner::{
    DeadlineInfo, Method as MinerMethod, MovePartitionsParams, ProveCommitSectorParams,
    State as MinerState, power_for_sector,
};
...
fn setup(store: &'_ MemoryBlockstore) -> (TestVM, MinerInfo, SectorInfo) {
