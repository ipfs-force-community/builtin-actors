use fil_actor_miner::{
    DeadlineInfo, SectorOnChainInfo, State, deadline_available_for_compaction,
    deadline_available_for_optimistic_post_dispute, deadline_is_mutable, new_deadline_info,
